...
def load_model():
    ...
    model.load_weights('data_model/face_recognition_restnet50_11112020Phase1.h5')
    return model
# def load_model():
#     model = tf.keras.models.load_model('data_model/face_recognition_restnet50_11112020Phase1.h5')
#     return model
